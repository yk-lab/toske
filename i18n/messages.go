...
You can override the default path by setting the TOSKE_CONFIG environment variable.`,
		...
		"delete.noBackup":           "Project '%s' has no backups. Please run 'toske backup --project %s' first.",
		"delete.noRepositoryPath":   "Project '%s' does not have repository_path configured.",
		"delete.removingRepository": "Removing repository directory: %s",
		"delete.repositoryRemoved":  "✓ Repository directory removed successfully",
		"delete.removeRepoError":    "Failed to remove repository directory: %v",
		"delete.confirmHeader":      "The following will be deleted:",
		"delete.confirmProject":     "Project: %s",
		"delete.confirmRepoPath":    "Repository: %s (will be physically deleted)",
		"delete.confirmNoRepo":      "Repository: %s (not found, will skip)",
		"delete.confirmPrompt":      "Are you sure you want to continue? [y/N]: ",
		...
		// Prune command
		"prune.short":              "Prune old backup files",
		"prune.long":               "Delete old backup files to keep only a specified number of recent backups.\nYou can target a specific project with --project or all projects with --all.",
		"prune.noConfig":           "Configuration file does not exist: %s\nRun 'toske init' to create one.",
		"prune.readError":          "Failed to read configuration file: %v",
		"prune.parseError":         "Failed to parse configuration file: %v",
		"prune.noProjects":         "No projects found in configuration file.",
		"prune.projectNotFound":    "Project '%s' not found in configuration file.",
		"prune.homeDirError":       "Failed to get home directory: %v",
		"prune.bothFlags":          "Cannot specify both --project and --all flags at the same time.",
		"prune.noFlags":            "Either --project or --all flag is required.",
		"prune.invalidKeep":        "The --keep value must be greater than or equal to 0.",
		"prune.noBackupDir":        "Backup directory does not exist.",
		"prune.noMetadata":         "Backup metadata file does not exist.",
		"prune.noBackups":          "No backups found.",
		"prune.readMetadataError":  "Failed to read backup metadata: %v",
		"prune.parseMetadataError": "Failed to parse backup metadata: %v",
		"prune.noPruneNeeded":      "Current backup count (%d) is already within retention limit (%d). No pruning needed.",
		"prune.deleteError":        "Failed to delete backup file %s: %v",
		...
		"prune.processingProject":  "Processing project: %s",
		"prune.pruned":             "Kept %d backup(s)",
		"prune.deleted":            "Deleted %d old backup(s)",
		"prune.error":              "Error: %v",
		"prune.success":            "✓ Prune completed successfully!",
		"prune.summary":            "Summary:",
		"prune.summarySuccess":     "  ✓ Successfully pruned: %d project(s)",
		"prune.summarySkipped":     "  ⊘ Skipped: %d project(s)",
		"prune.summaryError":       "  ✗ Errors: %d project(s)",
...
TOSKE_CONFIG 環境変数を設定することで、デフォルトパスを上書きできます。`,
		...
		"delete.noBackup":           "プロジェクト '%s' にバックアップがありません。先に 'toske backup --project %s' を実行してください。",
		"delete.noRepositoryPath":   "プロジェクト '%s' に repository_path が設定されていません。",
		"delete.removingRepository": "リポジトリディレクトリを削除しています: %s",
		"delete.repositoryRemoved":  "✓ リポジトリディレクトリを削除しました",
		"delete.removeRepoError":    "リポジトリディレクトリの削除に失敗しました: %v",
		"delete.confirmHeader":      "以下を削除します:",
		"delete.confirmProject":     "プロジェクト: %s",
		"delete.confirmRepoPath":    "リポジトリ: %s (物理削除されます)",
		"delete.confirmNoRepo":      "リポジトリ: %s (見つかりません。スキップします)",
		"delete.confirmPrompt":      "本当に削除しますか? [y/N]: ",
		...
		// Prune command
		"prune.short":              "古いバックアップファイルを削除",
		"prune.long":               "古いバックアップファイルを削除して、指定件数の最新バックアップのみを保持します。\n--project で特定プロジェクト、--all ですべてのプロジェクトを対象にできます。",
		"prune.noConfig":           "設定ファイルが存在しません: %s\n'toske init' を実行して作成してください。",
		"prune.readError":          "設定ファイルの読み込みに失敗しました: %v",
		"prune.parseError":         "設定ファイルのパースに失敗しました: %v",
		"prune.noProjects":         "設定ファイルにプロジェクトが見つかりません。",
		"prune.projectNotFound":    "プロジェクト '%s' が設定ファイルに見つかりません。",
		"prune.homeDirError":       "ホームディレクトリの取得に失敗しました: %v",
		"prune.bothFlags":          "--project と --all フラグを同時に指定することはできません。",
		"prune.noFlags":            "--project または --all フラグのいずれかが必要です。",
		"prune.invalidKeep":        "--keep の値は0以上である必要があります。",
		"prune.noBackupDir":        "バックアップディレクトリが存在しません。",
		"prune.noMetadata":         "バックアップメタデータファイルが存在しません。",
		"prune.noBackups":          "バックアップが見つかりません。",
		"prune.readMetadataError":  "バックアップメタデータの読み込みに失敗しました: %v",
		"prune.parseMetadataError": "バックアップメタデータのパースに失敗しました: %v",
		"prune.noPruneNeeded":      "現在のバックアップ件数 (%d) は既に保持件数 (%d) 以下です。削除は不要です。",
		"prune.deleteError":        "バックアップファイル %s の削除に失敗しました: %v",
		...
		"prune.processingProject":  "プロジェクトを処理中: %s",
		"prune.pruned":             "%d 件のバックアップを保持しました",
		"prune.deleted":            "%d 件の古いバックアップを削除しました",
		"prune.error":              "エラー: %v",
		"prune.success":            "✓ 整理が正常に完了しました！",
		"prune.summary":            "サマリー:",
		"prune.summarySuccess":     "  ✓ 正常に整理: %d プロジェクト",
		"prune.summarySkipped":     "  ⊘ スキップ: %d プロジェクト",
		"prune.summaryError":       "  ✗ エラー: %d プロジェクト",
